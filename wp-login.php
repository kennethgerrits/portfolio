...
<!--[if IE 8]>
	...
	<![endif]--><!--[if !(IE 8) ]><!--><html xmlns="http://www.w3.org/1999/xhtml" lang="nl">
	<!--<![endif]-->
	<head>
...
<link rel="stylesheet" id="login-css" href="https://kennethgerrits.github.io/portfolio/wp-admin/css/login.min.css?ver=5.4.8" media="all">
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="https://kennethgerrits.github.io/portfolio/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Inloggen">
									<input type="hidden" name="redirect_to" value="https://kennethgerrits.github.io/portfolio/wp-admin/">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
									<a href="https://kennethgerrits.github.io/portfolio/wp-login.php?action=lostpassword">Wachtwoord vergeten?</a>
								</p>
					<script type="text/javascript">
